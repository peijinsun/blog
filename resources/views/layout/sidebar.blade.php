            ...
            <div id="recent-menu" class="menu tab-pane fade in active">
                ...
                <div class="row list_item">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="list_bot"><a class="grey click-count-wrap" title="点击数"><i class="click-icon"></i><span class="click-count">{{$rec['clicks']}}</span></a>
                        <!--<a class="grey comment-count-wrap" title="评论"><i class="comment-icon"></i><span class="comment-count">171</span></a>-->
                        </div>
                    </div>
                </div>
				<hr>
            ...
            <div id="pop-menu" class="menu tab-pane fade in active">
                ...
                <div class="row list_item">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="list_bot"><a class="grey click-count-wrap" title="点击数"><i class="click-icon"></i><span class="click-count">{{$pop['clicks']}}</span></a><!--<a title="评论" class="grey comment-count-wrap"><i class="comment-icon"></i><span class="comment-count">171</span></a>--></div>
                    </div>
                </div>
				<hr>
                @endforeach
